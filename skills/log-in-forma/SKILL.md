...
Read all design files in the current directory: `frame.md`, `ideation.md`, `wireframes-v*.md`, `test-results-v*.md`, and any existing session notes in `sessions/`. These represent what's already been captured. Your job is to find what hasn't.
